...
class Reflector extends Mesh {
	...
	constructor( geometry, options = {} ) {
		...
		const renderTarget = new WebGLRenderTarget( textureWidth, textureHeight, { samples: multisample, type: HalfFloatType, minFilter: LinearFilter, magFilter: LinearFilter } );
...
Reflector.ReflectorShader = {
	...
	fragmentShader: /* glsl */`
		...
		void main() {
            ...
            // Mix base reflection with color to make it look like water
            gl_FragColor = vec4( mix(base.rgb, color, 0.3), 0.9 );
